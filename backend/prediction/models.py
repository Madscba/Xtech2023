...
# python manage.py inspectdb --database 'production' > models_db_inspect.txt  
...
class DiagnosisEvents(models.Model):
    ...
    user = models.ForeignKey(Users, models.DO_NOTHING, to_field='id', blank=True, null=True)
    practioner = models.ForeignKey(Users, models.DO_NOTHING, related_name="prac",to_field ='practioner_id', blank=True, null=True)
...
class SubmittedEyes(models.Model):
    id = models.AutoField(primary_key=True)
    diagnosis_event = models.ForeignKey(DiagnosisEvents, models.DO_NOTHING, to_field='id', blank=True, null=True)
    ...
    user = models.ForeignKey(Users, models.DO_NOTHING, related_name="user", to_field='id', blank=True, null=True)
